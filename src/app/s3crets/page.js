...
const Secrets = () => {
  ...
  return (
    <div
      className={
        darkMode
          ? `text-[#dcdde2] h-screen flex flex-col bg-[#101014] transition-all duration-[5000ms]`
          : `text-[#101014] h-screen flex flex-col bg-[#dcdde2] transition-all duration-[5000ms]`
      }
    >
      <div
        className={
          darkMode
            ? `flex justify-between items-end p-4 md:p-8 border-b-2 border-[#1c1d24] transition-all duration-500`
      ...
      >
        <div className="flex items-end">
          <span
            className={
              darkMode
                ? "font-gambarino text-4xl md:text-7xl text-[#dcdde2] hover:text-[#B8C0DC] cursor-help tracking-tight transition-all duration-500"
                : "font-gambarino text-4xl md:text-7xl text-[#323232] hover:text-[#B8C0DC] cursor-help tracking-tight transition-all duration-500"
            }
          >
          ...
          <a
            ...
            className={
              darkMode
                ? "flex items-center font-gambarino font-light text-sm md:text-lg text-[#323232] hover:text-[#B8C0DC] tracking-tight transition-all duration-500"
                : "flex items-center font-gambarino font-light text-sm md:text-lg text-[#aaaaaa] hover:text-[#B8C0DC] tracking-tight transition-all duration-500"
            }
          >
        ...
        <div>
          <button
            ...
            className={
              darkMode
                ? `rounded-full w-16 text-xl h-16 flex items-center justify-center border-[2px] border-[#1c1d24] hover:scale-105 transition-all delay-100`
      ...
      <div
        className={
          darkMode
            ? "flex flex-col px-4 md:px-8 py-4 md:py-6 border-b-2 border-[#1c1d24] transition-all duration-500 cursor-none"
      ...
      >
        ...
        <div
          className={
            darkMode
              ? "flex justify-between font-esenka text-sm md:text-3xl text-[#dcdde2] transition-all duration-500"
        ...
        >
          ...
          >
            <div className="flex justify-between w-full hover:text-[#B8C0DC] cursor-none">
              <span className="w-[90%]">
