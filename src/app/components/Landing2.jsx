    ...
    items: [
      {
        ...
        number: "1",
        description: "Designed and developed using Next.js, Tailwind CSS, Prisma ORM, and Neon Serverless PostgreSQL, featuring robust CRUD operations for wardrobe and outfit management, secure authentication, and ease of use for cataloging items and building shareable outfits.",
        technologies: ["Next.js", "Tailwind CSS", "Prisma", "PostgreSQL", "NeonDB"]
      },
      {
        name: "GAMITRONICS",
        ...
        number: "2",
        description: "Managed cross-team coordination and weekly task planning across active game projects. Oversaw task tracking and documentation using ClickUp and internal wiki systems. Built workflows for testing, daily logs, and milestone-based reporting.",
        technologies: ["ClickUp", "Wiki Documentation", "Team Coordination", "QA Workflows"]
      },
      {
        name: "GAMITRONICS",
        ...
        url: "https://gamitronics.com",
        number: "3",
        description: "Developed an end-to-end Backend for a Unity VR game. Tasks included API design and development, Database architecture and implementation, integration and deployment. Worked with various platform SDKs to implement player authentication and cross-platform functionality.",
        technologies: ["ExpressJS", "MongoDB", "Steamworks SDK", "Oculus API", "PSN API"]
      },
      {
        ...
        number: "4",
        description: "Services start-up proficient in digital product design and development. Provides end-to-end solutions for UI/UX Design, Web Development, Application Development and Cloud services.",
        technologies: ["Web Development", "UI/UX Design", "Cloud Services", "Project Management"]
      },
      {
        ...
        number: "5",
        description: "Appointed as Chapter Director for the Hyderabad Startup Grind Chapter. Role includes: Hosting events, community management, strong communication and network outreach, and most importantly making friends along the way.",
        technologies: ["Event Management", "Community Building", "Network Development", "Communication"]
      },
      {
        name: "TALENTMAPP",
        role: "Co-Founder",
      ...
      },
      {
        ...
        number: "8",
        description: "End-To-End Hospital + Dispensary management system for Samsung Tablets, developed in React Native, Expo SDK front end and a PostgreSQL backend. Attendance Management with geolocation and calculation of employee to dispensary location distance. EHR, i.e: patient entry records. Fully interactive admin dashboard for data visualization and employee management.",
        technologies: ["React Native", "Expo SDK", "PostgreSQL", "Geolocation", "EHR"]
      },
      {
        name: "HUNTSJOB",
        ...
        number: "9",
        description: "Developed entire cross-platform mobile application using React Native as per client specifications. Re-designed pre-existing UI and Pattern Library implementing custom-built components using React Native's StyleSheet.",
        technologies: ["React Native", "StyleSheet", "Mobile UI/UX", "Cross-platform"]
      },
      {
        ...
        number: "10",
        description: "Implemented the front-end of the landmark/tourist attraction reference site using React.js, ensuring a user-friendly interface and responsive design. Integrated Mapbox for coordinate data visualization, enhancing the user experience by providing interactive maps. Developed the back-end authentication system and landmark data storage using MongoDB, allowing for secure user login and data management.",
    ...
    items: [
      {
        ...
        number: "1",
        description: "Completed 4 year undergraduate degree in Bachelors in Technology, specialized in Computer Science. Gained core knowledge in data structures, algorithms, computer architecture, operating systems, database management, and software engineering. Undertook elective coursework in emerging tech areas such as web technologies, digital systems, and design thinking. Participated in multiple industry-aligned internships."
      },
      {
...
const Landing = () => {
  ...
  useEffect(() => {
    ...
    const handleKeyPress = (event) => {
      ...
      if (konamiCode.includes(newKonami) && newKonami.length <= konamiCode.length) {
        setKonami(newKonami);
    ...
    >
      ...
      {showEgg && (
        <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
          <div className={`p-6 rounded-md shadow-lg transform scale-up transition-all duration-500 ${
            darkMode ? "bg-[#242424] text-[#ECECEC]" : "bg-[#f2f2f2] text-[#3c3c3c]"
          }`}>
      ...
      >
        ...
        <div>
          <button
            ...
            className={`rounded-full w-9 h-9 text-lg md:w-16 md:text-xl md:h-16 flex items-center justify-center border-[1px] md:border-[2px] hover:scale-110 transform transition-all duration-300 ${
          ...
          >
            <div className="relative overflow-hidden h-full w-full flex items-center justify-center">
              <span className={`absolute transition-all duration-500 ${darkMode ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>🌑</span>
              <span className={`absolute transition-all duration-500 ${darkMode ? 'translate-y-10 opacity-0' : 'translate-y-0 opacity-100'}`}>☀️</span>
            </div>
          </button>
        </div>
      </div>
        ...
        >
          ...
          <span className="font-gambarino flex items-center">
            ...
            <button 
              ...
              onClick={(e) => { e.stopPropagation(); toggleSection('whatIDo'); }}
            >
              {expandedSections.whatIDo ? 
                <span className="text-xl md:text-2xl transform translate-y-[-2px]">−</span> : 
            ...
            <div className="font-esenka text-lg md:text-3xl font-black py-4 md:py-8 w-full">
              ...
              <div className="flex justify-between w-full">
                {[...Array(2)].map((_, colIndex) => {
                  const itemsPerColumn = Math.ceil(data.whatIDo.items.length / 2);
                  const startIndex = colIndex * itemsPerColumn;
                  const columnItems = data.whatIDo.items.slice(startIndex, startIndex + itemsPerColumn);
                  ...
                  return (
                    <div key={colIndex} className={`flex flex-col gap-2 md:gap-4 ${
                      ...
                      {columnItems.map((item, index) => (
                        ...
                        >
                          <div className={`w-6 md:w-8 text-center font-esenka font-normal text-xs md:text-xl ${
                            darkMode ? "text-[#464545]" : "text-[#aaaaaa]"
                          }`}>
                            {item.number}
                          </div>
        ...
        >
          ...
          <span className="font-gambarino flex items-center">
            ...
            <button 
              ...
              onClick={(e) => { e.stopPropagation(); toggleSection('techStack'); }}
            >
            ...
            <div className="font-esenka text-lg md:text-3xl font-black py-4 md:py-8 w-full">
              ...
              <div className="flex justify-between w-full">
                {[...Array(3)].map((_, colIndex) => {
                  const itemsPerColumn = Math.ceil(data.techStack.items.length / 3);
                  const startIndex = colIndex * itemsPerColumn;
                  const columnItems = data.techStack.items.slice(startIndex, startIndex + itemsPerColumn);
                  
                  return (
                    <div key={colIndex} className={`flex flex-col gap-2 md:gap-4 ${
                      colIndex === 0 ? '' : 
                      colIndex === 1 ? 'items-center text-center' : 
        ...
        >
          ...
          >
            {expandedSections.experience ? 
              <span className="text-xl md:text-lg transform translate-y-[-2px]">−</span> : 
                      ...
                      <div className="flex items-center group/item">
                        ...
                        >
                          {expandedExperience === index ? 
                            <span className="text-xl md:text-xl transform translate-y-[-2px]">−</span> : 
                        ...
                        {item.technologies.map((tech, i) => (
                          <span 
                            ...
                            style={{ 
                              ...
                              transform: expandedExperience === index 
                                ? 'translateY(0px)' 
                                : 'translateY(10px)'
                            }}
                          >
                  ...
                  <div className="flex justify-between w-full">
                    <div className="flex flex-col gap-0 md:gap-4 md:flex md:flex-row md:items-end">
                      <div className="flex items-center group/item">
                        ...
                        <button 
                          onClick={(e) => { e.stopPropagation(); toggleEducation(index); }}
                          className={`ml-2 w-5 h-5 md:w-6 md:h-6 flex items-center justify-center rounded-full hover:text-[#8BCD00] transition-colors duration-300 group-hover/item:text-[#8BCD00]`}
                        >
      ...
      >
        ...
        >
          ...
          <button 
            ...
            onClick={(e) => { e.stopPropagation(); toggleSection('socials'); }}
          >
      ...
      <div className="flex flex-col px-4 md:px-8 py-4 md:py-6">
        ...
        <div className="transition-all duration-500 ease-in-out">
          <div
            className={`flex md:flex-row flex-col md:justify-between mt-8 md:mt-20 font-apercu text-sm md:text-xl tracking-tight ${
              darkMode ? " text-[#515151]" : " text-[#939393]"
            }`}
          >
            <div className="flex flex-col mb-4 md:mb-0">
              <a href="mailto:sarvagk@gmail.com" className="hover:text-[#8BCD00] transition-colors duration-300">sarvagk@gmail.com</a>
              <a href="tel:+919533586416" className="hover:text-[#8BCD00] transition-colors duration-300">+91 95335 86416</a>
            </div>
            
            <div className="flex flex-col">
              <p className="font-medium">Frisco, Texas, USA</p>
              <p className="mt-2 text-xs md:text-sm">Full-Stack Developer & Video Game Producer</p>
          <div className="flex justify-center mt-3 opacity-75">
          ...
          {/* Konami code hint with key icons */}
        </div>
      </div>
    </div>
  );
